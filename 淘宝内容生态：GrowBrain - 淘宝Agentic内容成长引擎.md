...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1yQ0xRRSdCtMvtxvzLICSUqyjHXXeywViaXibJk3JNtbw77wWctpccvUyTUEVXDZCw9SiaeBjSgROJZl6HePFdYjtHUticqDhVibxsc/640?wx_fmt=png&from=appmsg#imgIndex=1)
...
预期的 ReactAgent 流程：第一次 LLM 调用 → LLM 返回 function\_call 要求调用 `content_potential_tool` → 框架执行工具拿到真实潜力分 → 第二次 LLM 调用 → 基于真实数据返回最终结果。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1whnH1y9JXhWvhCUlx04lUGuEPvEzhlRtj52GA6zv0tRYEWFlca7qq4MRhc6wqZ1IfNuQ8cge2yjq707ibjTeOX1Zz0ibnibTkhsc/640?wx_fmt=png&from=appmsg#imgIndex=2)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1wZCtkcTLHfZopUiaWbvev0XziasxAVF88lBciccQeiayPUNnibBicQEWTUDTTsqrgxCCrBtxqmiagTPqVEwDiaI6PDVOMmvyv12gaZ6pQ/640?wx_fmt=png&from=appmsg#imgIndex=3)
...
![](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1xy8ZYGAJdFLNofiafsG9NLxicKr8tviarBTp6NNarzJs3qNDSzjJAtiazNGkmImJ7WjQ3peDfzBIKweCU4oCG0tx5Pb4ribB2ydgPg/640?wx_fmt=png&from=appmsg#imgIndex=4)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1ynQ2VrNgXLTBiam0M9Iic6zibA01aYJXXAZbHYcOZXRjjA1PRX0LWkXPRJfGWoQibYfdHNOJWDfvjibcSB31bTVicczxQ2B0ibb3MD40/640?wx_fmt=png&from=appmsg#imgIndex=5)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1y37R8RYtDU5ibfrwLktXWw7n7iabtTtm5QKib7o4YxPjqyDQiaTiawXnDwCiaYKicBCHnoFnnxgDhIicxKCsRztIO2JHANcoE9pzTsg0A/640?wx_fmt=png&from=appmsg#imgIndex=6)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1yhickicf9uHRlMp77f46DA3hZYKbiaOLwMgt9x3HvGVia3HLAGKaR8SVDiboUXibPVHm3xHugGoYb7PN1DjrGGa7mAyB68S6icmM58yE/640?wx_fmt=png&from=appmsg#imgIndex=7)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1zkgfWBHHRfzawNMTwoXJ4mTrJgqgjDx9YdiccmUFgf9iacpM1BVm87MWOXVYMeFbdiaJHicN9KbEZewHYz6yzQJndjEOZtgr8trbU/640?wx_fmt=png&from=appmsg#imgIndex=8)
...
*   第三阶段（CoT Distillation）：去除完整思考过程，仅保留 target\_pv + reason 构建训练数据，LoRA 微调轻量级生产模型
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1yiaQvC4jNneNJT1FibQCQAEyrXefcws6RGibsOkAGPkUKrcYRwpHhTO8n2dIlE9xN05c3EZVJB1WYFY6eLK3vbB1qdI2pgdIJ4xk/640?wx_fmt=png&from=appmsg#imgIndex=9)
...
*   7 天峰值衰减检测。通过划定近7天流量趋势时间窗口，输出峰值绝对值、峰值日期与 drop\_ratio ∈ \[0,1\]，并区分「持续下降 / 今日下降 / 今日即峰值 / 历史峰值低位」四种状态，定位"是新内容流量没起来还是老内容流量在掉"
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1xQoXwoB2Pbh0ZwLcy5OGICxEWekJr6s7FrPfXHmFdibz8Ro6Zsl9M9DOQ8SnhUPGL8tdp2gkTzeZWk4KF7icemkUJLpGCMzOenc/640?wx_fmt=png&from=appmsg#imgIndex=10)
